  ...
  PersianDatePickerWidget? init() {
    {
      ...
      print('finish date time:: $finishDatetime');
      print('gregoriandatetime :: $gregorianDatetime');
      print('gregorian finish date time:: $gregorianFinishDatetime');
      ...
      if ((datetime != '' && finishDatetime != '') ||
          (gregorianDatetime != '' && gregorianFinishDatetime != '')) {
...
class PersianDatePickerWidget extends StatefulWidget {
  ...
  update(
    ...
    if (minDatetime != '') {
      ...
      options!['minDatetime'] = minDatetime;
    }
    if (maxDatetime != '') {
      options!['maxDatetime'] = maxDatetime;
    }
  }
...
class _PersianDatePickerWidgetState extends State<PersianDatePickerWidget>
  ...
  Jalaali? inputSelectedDate, rangeStartDate, rangeFinishDate;

  double? datePickerHeight;

  int? selectedPageIndex, todayPageIndex;
  ...
  ScrollController? displayYearsController, displayMonthsController;
  ...
  String? controllerTextTmp, oldText;
